 ...
 <body>
    ...
    <div id="content-star-goods">
    	<div id="star-goods-content">
        	<div id="star-goods-content-title">
            	<span class="title_span">步登新品推荐</span>
    ...
    <div id="main-show-box">
        <div class="list-title">
            <p><strong style="border-bottom:solid 2px #00c3d5;">步登明星单品</strong></p><a href="#">More</a>
        </div>
        ...
        <div class="list-title">
            <p><strong style="border-bottom:solid 2px #54cb00;">步登热评产品</strong></p><a href="#">More</a>
        </div>
        <div class="main-show-box-goods">
        	 <ul>
